...
import {
  ...
  acknowledgeDesktopMainWindowCloseRequest,
  keepaliveDesktopMainWindowCloseRequest,
  ...
  restartDesktopApp,
  resolveDesktopMainWindowCloseRequest,
  saveCustomIndicatorAiConversionGuide,
  setDesktopMainWindowCloseHandlerStatus,
