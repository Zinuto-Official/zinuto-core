...
export type DesktopOnboardingGuideAction =
  | "SELECT_TARGET"
  | "NEXT"
  | "BACK"
  | "SKIP"
...
type DesktopOnboardingGuideFrameProps = {
  payload: DesktopOnboardingWindowPayload;
  onAction: (
    action: DesktopOnboardingGuideAction,
    payload?: { targetId: DesktopOnboardingTargetId },
  ) => void;
};

export const DesktopOnboardingGuideFrame = ({
  payload,
  onAction,
}: DesktopOnboardingGuideFrameProps) => {
    ...
    <>
      ...
      <div className="desktop-onboarding-action-group">
        ...
        <Button
          ...
          size="sm"
          onClick={() =>
            onAction(payload.isFinalStep ? "PRIMARY" : "NEXT")
          }
        >
          {payload.primaryIcon ? (
        ...
        {payload.rows.map((row, index) => {
          ...
          return (
            <Button
              ...
              onClick={() =>
                onAction("SELECT_TARGET", { targetId: row.targetId })
              }
            >
